    ...
    async def _run_agentic_loop(
        ...
        system = build_system_prompt(
            ...
            extra=(time_block + prefs_block +
                ...
                "- WRITES (anything that produces a PR): require EXPLICIT "
                "  user confirmation before firing claude_code. Diagnose "
                "  + propose first, wait for 'sí' / 'arréglalo' / 'abre "
                "  PR' / 'do it', THEN call claude_code with the write "
                "  prompt. Same for claude_code_new_project — confirm "
                "  the repo name + scope before creating.\n"
